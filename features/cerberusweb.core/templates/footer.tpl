...
<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
    <tr>
      <td nowrap="nowrap" valign="top">
      	...
      	<b>Cerberus Helpdesk</b>&trade; &copy; 2002-2010, WebGroup Media&trade; LLC - Version {$smarty.const.APP_VERSION} Cerb5Blog Fix Branch (Build {$smarty.const.APP_BUILD}) 
      	<br>
